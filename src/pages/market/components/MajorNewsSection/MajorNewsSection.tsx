import * as styles from "./MajorNewsSection.css";

export function MajorNewsSection() {
    return (
        <section className={styles.container}>
            <h2 className={styles.sectionTitle}>주요 뉴스</h2>
            ...
            <article className={styles.newsCard}>
                <div className={styles.badge}>
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <clipPath id="clip0_893_3901">
                                <rect width="12" height="12" fill="white"/>
                            </clipPath>
                        </defs>
                    </svg>

                    <span>주요증권 소식 한 줄 요약</span>
                </div>

                <h3 className={styles.companyName}>주성엔지니어링</h3>
                <p className={styles.headline}>실적 악화 발표로 -3.5% 하락</p>
            </article>
        </section>
    );
}