  ...
  return (
    <header className={styles.stockDetailHeader}>
      <div className={styles.headerTitleGroup}>
        ...
        <span className={styles.headerTitle}>나의투자</span>
      </div>
  ...
  return (
    <header className={styles.stockDetailHeader}>
      <div className={styles.headerTitleGroup}>
        ...
        <span className={styles.headerTitle}>환전소</span>
      </div>
      <div className={styles.stockDetailIconGroup}>
        <button className={styles.iconButton} aria-label="관심 종목 추가">
          <svg
...
export default function Header() {
  ...
  if (isMyInvestmentPage) {
    return <MyInvestmentHeader />;
  }
